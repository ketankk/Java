...
public class DataProvider extends ContentProvider {
	...
	public static final String COL_MESSAGES = "msg";
...
switch(uriMatcher.match(uri)){
	...
	static {
		...
		uriMatcher
				.addURI("kk.play.chat.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("kk.play.chat.provider", "messages/#",
				MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("kk.play.chat.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("kk.play.chat.provider", "profile/#",
				PROFILE_SINGLE_ROW);
	}
